...
public class GeradorCrudHelper
{
    ...
    public static void cerarCdru(String entity)
    {
    ...
    {
        criarDir("resources/xgen");
        criarDir("resources/xgen/repository");
        criarDir("resources/xgen/builder");
        criarDir("resources/xgen/rule");
        criarDir("test/resources/xgen/service");
        criarDir("test/resources/xgen/validation");
        criarDir("test/resources/xgen/consulta");
        criarDir("test/resources/xgen/cadastro");
        criarDir("test/resources/xgen/web");
    }

    private static boolean criarDir(String nome)
    {
